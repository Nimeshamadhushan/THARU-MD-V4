...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            let textw = "";
            textw += `* 🦄 THARU_ᴡᴇᴀᴛʜᴇʀ ʀᴇᴘᴏʀᴛ ᴏғ  ${text}*\n\n`;
...
cmd({
    ...
    async(Void, citel, text) => {
        ...
        google({ 'query': text}).then(res => {
            let msg= `🦄THARU ɢᴏᴏɢʟᴇ sᴇᴀʀᴄʜ  : ${text} \n\n`;
            for (let g of res) {
                msg+= `📌 Title : ${g.title}\n`;
...
cmd({
    ...
    async(Void, citel, text) => {
        ...
        for (let i = 0; i < parseInt(name2); i++) {
            ...
            await Void.sendMessage(citel.chat, {image: {  url: images,}, caption: `_THARU ɪᴍᴀɢᴇ ᴅᴏᴡɴʟᴏᴅᴇʀ_\n*${name1}*`,}, { quoted: citel, });
        }
    }
)
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            Void.sendMessage(citel.chat, { image: { url: random.male }, caption: `🦄THARU ɪᴍᴀɢᴇ ᴅᴏᴡɴʟᴏᴅᴇʀ` }, { quoted: citel })
            Void.sendMessage(citel.chat, { image: { url: random.female }, caption: `🦄THARU ɪᴍᴀɢᴇ ᴅᴏᴡɴʟᴏᴅᴇʀ` }, { quoted: citel })
        }
    )
    //---------------------------------------------------------------------------
cmd({

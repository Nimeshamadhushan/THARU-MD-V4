...
cmd({
    ...
    async(Void, citel, text) => {
        await Void.sendMessage(`${citel.chat}`, {
            image: log0,
            caption: `*Support : Official THARU-MD-Support*\n*Group link:-https://chat.whatsapp.com/J085BIRq2F614d44rWS4Co`,
        });
